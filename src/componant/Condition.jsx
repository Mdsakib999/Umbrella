...
const Condition = () => {
    return (
      ...
      <div className="lg:w-[75%] w-[90%] mx-auto">
        <p className='font-bold text-lg'>Sort Insurance Trading Under Sort Services Ltd (Company Number: 12894301).</p>
        <p className='font-bold text-lg mt-4 mb-5'>We Can Assist You With Finding Quotations For Van Insurance, Fleet Insurance Including Courier Delivery Or Any Other Business Use. You Are Strongly Advised To Understand The Following Terms Below Thoroughly Before Accepting Our Services.</p>

        <div>
          <p className="text-lg font-semibold">1. Introduction</p>
          <p><span className='font-bold mr-2'>1.1</span> 
          This website doesn't generate any quotes itself like other comparison sites as we are not authorised to do so and all access to use of this Website is subject to these terms and conditions (“Terms of Use”). By accessing and using this Website you agree to be bound by these Terms of Use. If you do not agree to these Terms of Use, you are not permitted to access and use this Website and you should immediately cease accessing and using this Website.
          </p>
          <p><span className='font-bold mr-2'>1.2</span> 
          If you breach any provision of these Terms of Use then your right to access and use this Website will immediately cease.
          </p>
          <p><span className='font-bold mr-2'>1.3</span> 
          This Website is intended for use by UK residents only, aged 18 years and over. You should note that this Website (including products, price references and product descriptions) is frequently updated. Products may be withdrawn at any time, without notice.
          </p>
          <p><span className='font-bold mr-2'>1.4</span> 
          We may amend these Terms of Use at any time and so we recommend that you refer to these Terms of Use each time you use this Website. The amended Terms of Use will be effective from the date they are posted on this Website. Your continued use of this Website will constitute your acceptance of the amended Terms of Use.
          </p>
          <p><span className='font-bold mr-2'>1.5</span> 
          Sort Services Ltd is not the insurer but provides consultancy service and services of clerical nature.
          </p>
          <p><span className='font-bold mr-2'>1.6</span> 
          Sort Services Ltd does not give any advice or make any personal recommendations as to the suitability of any policy to individual or business client’s circumstances. We may describe policy features, but it is the client’s decision to buy.
          </p>
          <p><span className='font-bold mr-2'>1.7</span> 
          Sort Services Ltd is an independent price searching company (not associated with any insurer or underwriter), a 3rd Party who works on customer’s behalf only up to searching the quotations.
          </p>
        </div>

        <div>
          <p className="text-lg font-semibold mt-4">2. Privacy Policy</p>
          <p><span className='font-bold mr-2'>2.1</span> 
          We take your privacy seriously. Please visit our <Link className='text-red-500' to='/privacy'>Privacy Policy</Link> to find out how we use the information that you provide to us. Your use of this Website is at all times subject to the provisions of our Privacy Policy.
          </p>
          <p><span className='font-bold mr-2'>2.2</span> 
          We take your privacy seriously. Please visit our <Link className='text-red-500' to='/privacy'>Privacy Policy</Link> to find out how we use the information that you provide to us. Your use of this Website is at all times subject to the provisions of our Privacy Policy.
          </p>
        </div>
        ...
        <p><span className='font-bold mr-2'>3.1</span> 
        ...
        <p><span className='font-bold mr-2'>3.2 No Advice</span> 
        ...
        <p><span className='font-bold mr-2'>3.7 FSMA Regulatory and PCI DSS Compliance Information:</span> 
        ...
        <div>
          ...
          <p><span className='font-bold mr-2'>4.1</span> 
          You can apply for a number of products via this Website. These products are not provided by us but are instead provided by third parties over whom we do not have control. It is your responsibility to satisfy yourself that you wish to obtain any product before doing so. Before making a decision to purchase a product, you should consult the relevant product documents.
          </p>
          <p><span className='font-bold mr-2'>4.2</span> 
          All product prices are quoted in UK pounds(£).
          </p>
          <p><span className='font-bold mr-2'>4.3</span> 
          We are not responsible or liable for any loss or damage you or any third party may suffer or incur in connection with any product you obtain after using this Website or for any acts, omissions, errors or defaults of any third party in connection with that product.
          </p>
          <p><span className='font-bold mr-2'>4.4</span> 
          ...
          <p><span className='font-bold mr-2'>4.5</span> 
        ...
        <div>
          ...
          <p><span className='font-bold mr-2'>5.1</span> 
          All quotations are given on the basis of "Utmost good faith.
          </p>
          <p><span className='font-bold mr-2'>5.2</span> 
          You must act with utmost good faith toward all the questions and provide honest and accurate information at all times. This obligation applies at the time of applying for the policy and continues throughout the duration of the policy.
          </p>
          <p><span className='font-bold mr-2'>5.3</span> 
          We must be presented with a fair and complete statement of the nature of any risk submitted to them. If you do not provide complete and accurate information, containing all material facts and circumstances, then your policy may not be valid in the event of a claim or a higher premium may be payable.
          </p>
          <p><span className='font-bold mr-2'>5.4</span> 
          A circumstance is material if it would influence the judgment of a prudent the company in calculating the premium or assessing whether the risk would be accepted or rejected. Accordingly, you must provide all the facts material within such a submission and update this information where relevant between initial enquiry and attachment of any cover and during the term of any policy. This applies equally to new orders, adjustments, renewals, extensions of cover, endorsements and claims.
          </p>
          <p><span className='font-bold mr-2'>5.5</span> 
          Please note that your obligation to provide material information to the quotation firm is an overriding obligation. Where quotation firm do not request specific information within a proposal form or questionnaire, this does not mean that such information is not material. If you are in doubt as to whether information is material, please call us.
          </p>
        </div>
        ...
        <div>
          ...
          <p><span className='font-bold mr-2'>7.1</span> 
          ...
          <p><span className='font-bold mr-2'>7.2</span> 
