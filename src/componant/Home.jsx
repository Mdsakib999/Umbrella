        ...
        >
          <div className=" flex h-full items-center justify-center">
            <div className=" text-white">
              <h2 className="mb-4 text-6xl text-blue-500 font-semibold">
                Right cover at cheapest
              </h2>
              <p className="font-medium text-lg w-[60%] mx-auto mt-12 mb-16">
              ...
              <p
                ...
                className="rounded border-2 mt-8 w-[30%] mx-auto border-blue-600 bg-blue-600 px-7 pb-[8px] pt-[10px] font-medium leading-normal text-neutral-50 transition duration-150 ease-in-out hover:border-blue-600 hover:bg-blue-700 "
              >
                Get a Quote Now
              </p>
            </div>
